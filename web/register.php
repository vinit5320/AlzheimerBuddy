...
if(isset($_POST['btn_sign_up']))                                 
{
	...
	$sqlquery=$conn->query("select id from users where uname='$uname'");   
	...
	{
		echo "<script type='text/javascript'>alert('Username is already registered. Please try logging in.');</script>";
	}
}
