...
<body>
  ...
  if(isset($_POST['btn_save']))                                 
  {
    ...
    {
      $sqlquery = $conn->query("update personal set name = '$name', dob = '$dob', contact = '$contact', address = '$home_add' 
    ...
    <div class="row">
          ...
          <div class="col-md-9 personal-info">
            ...
            <label class="col-lg-3 control-label">Name:</label>
              <div class="col-lg-4">
                <input class="form-control" type="text" value="<?php echo $row['name']; ?>" required="" name="name">
              </div>
            </div>
            ...
            <label class="col-md-3 control-label">Home address:</label>
              <div class="col-md-8">
                <input class="form-control" type="text" value="<?php echo $row['address']; ?>" required="" name="home_add">
              </div>
            </div>
